...
function PokemonForm(props) {
  ...
  return (
    <>
    <h1 className="pokemonForm_header">Various Input Type Examples</h1>
    <form className="pokemonForm">

      {/* Name */}
      <label htmlFor="name" className="pokemonForm_label">
        <span className="pokemonForm_label_text">
      ...
      {/* Type */}
      <label className="pokemonForm_dropdown" htmlFor="type">
        <span>Type: (dropdown)</span>
        <select id="type" value={form.type} onChange={(e) => handleInputs(e)}>
      ...
      {/* Image */}
      <label className="pokemonForm_url" htmlFor="image">
        <span>Image (url input) <br/> Insert Link url</span>
        <input
          pattern="https://.*"
          type="url"
          id="image"
      ...
      {/* Checkboxes */}
      <label className="pokemonForm_checkbox" htmlFor="checkbox">
        <span>Checkbox</span>
        <input
          type="checkbox"
          value={checkbox}
      ...
      {/* Textarea */}
      <label className="pokemonForm_textarea" htmlFor="description">
